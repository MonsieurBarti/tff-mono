...
// the hook command's env. If `pnpm run test` inherits them, every
...
//
// Scrub defensively at worker startup. The scrub-git-env.sh shell wrapper
// from upstream was dropped in S03; this inline scrub is now the sole
// defense. Tests should never see GIT_* vars regardless of how invoked.
//
