...
├── apps/
│   ├── tff-cc/
│   │   ├── CONTEXT.md                 ← tff-cc domain language
│   │   └── docs/adr/                  ← tff-cc-specific decisions
│   └── tff-pi/
│       ├── CONTEXT.md                 ← tff-pi domain language
│       └── docs/adr/                  ← tff-pi-specific decisions
└── packages/
    └── core/
        ├── CONTEXT.md                 ← shared core domain language
